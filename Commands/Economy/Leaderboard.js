...
module.exports.run = async (bot, message, args) => 
{
    ...
    const symbol = await Canvas.loadImage('https://i.ibb.co/W31CNsz/Ryo.png')
    ...
    const embed = new Discord.MessageEmbed()
        .setColor('00e3ff')
        .setAuthor(`Leaderboard`, message.author.avatarURL({dynamic: true}))
        .setThumbnail(message.guild.iconURL({dynamic: true}))
        .setDescription(`${bot.set.currency} Ryo: **${value[me].value.toLocaleString()}**\n🏅 Rank: **${me + 1}**`)
...
{
    desc: "Displays a leaderboard showing the top 10 users with the most ryo in their bank.",
    command: "leaderboard",
    aliases: ["lb", "top"],
    category: "economy",
}